...
function setBirthdayYear(){
    ...
    if(targetPackageName == ASIA_TikTokPackageName){      
        ...
        var yearSeekBar = className("android.widget.SeekBar").id("com.zhiliaoapp.musically:id/v41").findOne(3000);
    }
    if (yearSeekBar) {
        let minYear = 1900;
        let maxYear = 2024;
        let targetYear = random(1990, 2005); // 1990-2005之间的随机整数
        ...
        if (delta > 0) {
            ...
            swipe(centerX, startY, centerX, endY, 1500);
...
try {
    ...
    //fullId("com.zhiliaoapp.musically:id/a8r")
    if(targetPackageName == ASIA_TikTokPackageName){      
        var continueBtn = className("android.widget.Button").id("com.ss.android.ugc.trill:id/a8r").findOne(3000);
    }else{
        var continueBtn = className("android.widget.Button").id("com.zhiliaoapp.musically:id/a8r").findOne(3000);
    }
    if(continueBtn){
        continueBtn.click();
        sleep(random(3000, 5000))
    ...
    if(targetPackageName == ASIA_TikTokPackageName){      
        ...
        var nameBtn = className("android.widget.Button").id("com.zhiliaoapp.musically:id/dn1").findOne(3000);
    }
    if(nameBtn){
        nameBtn.click();
        sleep(random(3000, 5000))
